...
function ProcessNode({ id, data, selected }: NodeProps<Node<ProcessNodeData>>) {
  const { label, color, width = 180, height = 52 } = data;
  ...
  return (
    <>
      ...
      <div
        className="rounded-md flex items-center justify-center min-w-[72px] min-h-[28px] transition-colors duration-150"
        style={{
          width: `${width}px`,
          height: `${height}px`,
          backgroundColor: bg,
